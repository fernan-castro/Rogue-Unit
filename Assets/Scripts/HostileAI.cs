...
public class HostileAI : MonoBehaviour
{
    ...
    private void FireProjectile() {
        ...
        Destroy(projectileRb.gameObject, 3f); // Destroy projectile after 3 seconds to prevent clutter
    }
    ...
    private void PerformAttack() {
        navAgent.SetDestination(transform.position); // Stop moving to attack

        if (playerTransform != null) {
            transform.LookAt(playerTransform); // Face the player before shooting
        }
